...
#define CONFIG_MODEL_LRTXXX 1
#define CONFIG_NK_IPSEC 1
#define CONFIG_NK_EZLINKVPN 1
...
#define CONFIG_NK_OPENVPN_SERVER 1

/*purpose     : CONFIG_NK_NEW_SYSLOG_DESIGN author : FRANK date : 2012-4-13*/
/*description : Support CONFIG_NK_NEW_SYSLOG_DESIGN*/
#define CONFIG_NK_NEW_SYSLOG_DESIGN 1

#define CONFIG_NK_8021Q_SIMPLE 1
#define CONFIG_NK_DHCP_RELAY 1
#define CONFIG_NK_DHCP_SERVER_RELAY 1
#define CONFIG_NK_L2TP_CLIENT 1

/* #define CONFIG_NK_BACKUP_DB 1 */

#define CONFIG_NK_IP_CONNTRACK_ENHANCE 1
