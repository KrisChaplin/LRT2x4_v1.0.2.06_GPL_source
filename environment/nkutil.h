...
/*purpose     : openvpn author : trenchen date : 2011-07-27 */
/*description : start openvpn                               */
#define ASH_PAGE_OPENVPN_SERVER		70
...
#define ASH_PAGE_EZLINK_UP			117
#define ASH_PAGE_EZLINK_DOWN		118
...
#define ASH_PAGE_RADVD			173
#define ASH_PAGE_6TO4			174
#define ASH_DO_DNSMASQ			175
#define ASH_PAGE_ACCESS_RULE_V6		176
#define ASH_DO_INIT_WAN_CONN_IPV6	177
#define ASH_DO_CHECK_WAN_GET_IPV6_IP 178
#define ASH_PAGE_SETUP_V6		179
#define ASH_DO_WAN_CONN_UP_V6	180
#define ASH_DO_WAN_CONN_DOWN_V6	181
#define ASH_BUTTON_DHCP_RELEASE_V6	182
#define ASH_BUTTON_DHCP_RENEW_V6	183
#define ASH_DO_DHCPPD	184
#define ASH_BUTTON_PPPOE_DISCONNECT_V6	185
#define ASH_BUTTON_PPPOE_CONNECT_V6	186
#define ASH_DO_SOURCE_ROUTE_V6		187
#endif
...
#define ASH_PHYLINK_USB_UP	420		//	Netklass USB Device physical link up event number //Robert 2009/10/17
#define ASH_PHYLINK_USB_DOWN	421		//	Netklass USB Device physical link down event number //Robert 2009/10/17
...
#define ASH_DO_L2TP_REDIAL 863 
#define ASH_DO_L2TP_CONNECT 864 
#define ASH_DO_L2TP_DISCONNECT 866 
#endif
#ifdef CONFIG_NK_8021Q_SIMPLE
#define ASH_DO_8021Q_SIMPLE 510
#endif
...
// --> wan settings
	...
	char isp_dns[3][64];
	char isp_interface[10];
	char isp_lanprefix[64];
	int isp_lanprefixlen;
	int linkup;
	int state;
//	add database & data structure for DMZ port 
// <--
...
typedef struct nkSysInfo {
	...
	int v6lanchanged;
#ifdef CONFIG_NK_DYNAMIC_PORT_NUM
	struct nkWanInfo_v6 wan_v6[8];
#else
	struct nkWanInfo_v6 wan_v6[CONFIG_NK_NUM_WAN+CONFIG_NK_NUM_DMZ+CONFIG_NK_NUM_USB];
#endif
#endif
