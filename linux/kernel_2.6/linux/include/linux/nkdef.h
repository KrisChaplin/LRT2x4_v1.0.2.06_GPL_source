...
/*purpose     : 0012950/14165  author : trenchen date : 2010-07-21 */
/*description : ipsec routing entry metric                   */
#define NK_IPSEC_METRIC			35

/*purpose     : ipv6 author : trenchen date : 2011-03-25 */
/*description : support ipv6 loadbalance                 */
#define NK_EQUALIZERV6_METRIC		20
...
#elif defined CONFIG_MODEL_LRTXXX
	#define FIRMWARE_VERSION            		"v1.0.2"
	#define FIRMWARE_RC_VERSION         		".06"
	#define BOOT_VERSION                		"v1.0.0"
	#define HARDWARE_VERSION            		"V03"
	#define HARDWARE_VERSION_G          		"V01"
	#define PRODUCT_NAME                		"LRTXXX"
	#define VENDOR_CODE                 		"ls"
	#define PLATFORM_CODE               		"LRTXXX"
...
#ifdef CONFIG_NK_BACKUP_DB
#define USER_CONFIG_START_ADDRESS   0xBF980000
#else
