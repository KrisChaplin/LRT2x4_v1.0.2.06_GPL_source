		...
		enum ip_conntrack_info ctinfo)
{
	...
	/* purpose : 0014713    author : paul.chen    date : 2011-10-06 */
	/* description : Don't use SIP ALG, Force to return NF_ACCEPT   */
	//printk(KERN_EMERG "[paul test]sip_help, nk_sip_alg = %d\n", nk_sip_alg);
	if(!nk_sip_alg)
	{
		return NF_ACCEPT;
	}
