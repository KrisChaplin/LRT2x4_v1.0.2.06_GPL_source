 ...
 *
 *	Version:	$Id: skbuff.c 13053 2013-12-11 10:37:28Z incifer $
 *
 *	Fixes:
...
#define PPPOEHDR    8
//-->
/* purpose : x over ipsec author: incifer date : 2013-11-18          */
/* description : pptp over ipsec need extra space                    */
#define NK_X_OVER_IPSEC 64
#define NK_EXTRA_OFFSET (VIDOFFSET + PPPOEHDR + NK_X_OVER_IPSEC)
...
/* 2007/10/04 incifer: support PPPoE NAT ACC */
    if (skb_copy_bits(skb, -headerlen, n->head + NK_EXTRA_OFFSET, headerlen + skb->len))
		BUG();
