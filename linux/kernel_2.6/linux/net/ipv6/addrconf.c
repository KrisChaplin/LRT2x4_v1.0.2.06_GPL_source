 ...
 *
 *	$Id: addrconf.c 11371 2012-10-25 02:28:51Z chunru $
 *
...
/* purpose     : 0016268    author : ChunRu    date : 2012-10-25 */
/* description : fix fc00::/7 cannot be set to route             */
...
{
	/* purpose     : CONFIG_IPV6    author : ChunRu    date : 2011-04-21  */	
	/* description : add dad failure to hw addr mechanism                          */
	struct inet6_dev *idev = ifp->idev;
...
/* purpose     : CONFIG_IPV6    author : ChunRu    date : 2011-07-19 */
/* description : clean disable_ipv6 flag when interface down                 */
...
/* description : revert Ben's code for not sending RS on WAN         */
/* purpose     : NK_CONFIG_IPV6  author : Ben  date : 2011-06-09
 * description : send RS 3 times per 4sec from interface that set as FORWARD(without LAN) */	
	if (ifp->idev->cnf.forwarding)
	//if (!strcmp(ifp->idev->dev->name, "eth0"))
		goto out;
...
static void addrconf_dad_kick(struct inet6_ifaddr *ifp)
{
	...
	/* purpose     : CONFIG_IPV6    author : Ben    date : 2011-06-10 */	
	/* description : add 500ms delay for linklocal only                  */
	if (ipv6_addr_type(&ifp->addr) & IPV6_ADDR_LINKLOCAL)
	/* purpose     : CONFIG_IPV6    author : ChunRu    date : 2011-06-01 */	
	/* description : add 500ms delay for dad test randomly fail                  */
	rand_num += 500;
...
/* description : revert Ben's code for not sending RS on WAN         */
/* purpose     : NK_CONFIG_IPV6  author : Ben  date : 2011-06-09
 * description : send RS from interface that set as FORWARD(without LAN) */	
...
#endif
/* purpose     : CONFIG_IPV6    author : ChunRu    date : 2011-07-18 */	
/* description : Let disable_ipv6 and accept_dad controlled by sysctl     */
		{
