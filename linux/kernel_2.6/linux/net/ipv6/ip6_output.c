 ...
 *
 *	$Id: ip6_output.c 8729 2011-05-31 03:37:38Z ben.tseng $
 *
...
int ip6_output(struct sk_buff *skb)
{
	...
	struct dst_entry *dst = skb->dst;
	struct inet6_dev *idev =  __in6_dev_get(dst->dev);
...
int ip6_forward(struct sk_buff *skb)
{
	...
	else
	{
		...
		/* purpose     : CONFIG_IPV6    author : ChunRu    date : 2011-04-21   */	
		/* description : send ICMP error message: beyond scope (not neighbor) */
