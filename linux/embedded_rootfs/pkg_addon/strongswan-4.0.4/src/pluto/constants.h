 ...
 * for more details.
 *
 * RCSID $Id: constants.h 12119 2013-07-09 13:59:35Z dio.li $
 */
...
#define QUICKMODE_DELAY					1	/* 1 sec */
...
#define IS_ISAKMP_ENCRYPTED(s)     (STATE_MAIN_I2 <= (s) && STATE_AGGR_R0!=(s) && STATE_AGGR_I1 != (s) && STATE_INFO != (s))
