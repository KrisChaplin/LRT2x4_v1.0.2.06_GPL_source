...
#define DEFAULT_AUTH_FILE "/etc/ppp/chap-secrets"
#endif
#ifndef DEFAULT_CONFIG_FILE
#define DEFAULT_CONFIG_FILE "/etc/l2tpd.conf"
#endif
#define ALT_DEFAULT_AUTH_FILE "/etc/ppp/chap-secrets"
#define ALT_DEFAULT_CONFIG_FILE "/etc/l2tpd.conf"
