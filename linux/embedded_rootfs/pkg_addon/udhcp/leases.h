...
struct dhcpOfferedAddr {
	...
	u_int32_t	packetType; //write leases for which packetType
};
...
#if 1
struct dhcpOfferedAddr *add_lease(u_int8_t *chaddr, u_int32_t yiaddr, unsigned long lease, char *hostname, u_int32_t packetType);
#else
